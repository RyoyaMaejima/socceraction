...
class VAEP:
    ...
    def __init__(
        ...
        self.yfns = [self._lab.scores, self._lab.concedes, self._lab.recoveries, self._lab.losts, self._lab.attacked, self._lab.attacks]
    ...
    def rate(
        self, a, c, game: pd.Series, game_actions: fs.Actions, game_states: Optional[fs.Features] = None
    ) -> pd.DataFrame:
        """
        ...
        p_scores, p_concedes, p_recoveries, p_losts, p_attacked, p_attacks = y_hat.scores, y_hat.concedes, y_hat.recoveries, y_hat.losts, y_hat.attacked, y_hat.attacks
        vaep_values = self._vaep.value(a, c, game_actions_with_names, p_scores, p_concedes, p_recoveries, p_losts, p_attacked, p_attacks)
        return vaep_values
